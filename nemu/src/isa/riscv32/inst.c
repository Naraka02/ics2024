...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc = isa_raise_intr(((cpu.csr.mstatus & MSTATUS_MPP) >> 10) == 2 ? 11 : 8 , s->pc));
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, s->dnpc = CSR(0x341);printf("%x\n",cpu.csr.mstatus); cpu.csr.mstatus = (cpu.csr.mstatus & ~MSTATUS_MIE) | ((cpu.csr.mstatus & MSTATUS_MPIE) >> 4); cpu.csr.mstatus = (cpu.csr.mstatus | MSTATUS_MPIE);printf("%x\n",cpu.csr.mstatus); );
